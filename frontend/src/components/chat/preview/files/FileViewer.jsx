...
export default function FileViewer({ activeIndex }) {
    ...
    console.log("输出: ", files[activeIndex]);
        ...
        <div className="w-full max-w-[60%]">
            ...
            <div className="flex justify-center items-center">
                {files[activeIndex]?.type === "IMAGE" ? (
                    <img src={files[activeIndex]?.fileData} className="max-w-[80%] object-contain hview"/>
                    ...
                    <div className="min-w-full hview flex flex-col items-center justify-center">
                        {/* File Icon Image */}
                        <img src={`../../../../images/file/${files[activeIndex]?.type}.png`}
