...
export default function Add() {
    ...
    return (
        <>
            <div className="w-14 h-14 mt-2 border dark:border-white rounded-md flex items-center justify-center cursor-pointer"
            ...
            <input type="file" hidden multiple ref={inputRef} onChange={filestHandler}
