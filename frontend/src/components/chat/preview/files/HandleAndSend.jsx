    ...
    return (
        <div className="w-[97%] flex items-center justify-between mt-2 border-t dark:border-dark_border_2">
            ...
            <div className="flex items-center gap-x-2">
                {files.map((file, i) => (
                    <div className={`fileThumbnail relative w-14 h-14 border dark:border-white mt-2 rounded-md overflow-hidden cursor-pointer
                        ${activeIndex === i ? "border-[3px] !border-green_1" : ""}`} 
                        onClick={() => setActiveIndex(i)} key={i} >
                        ...
                        {file.type === "IMAGE" ? (
                            ...
                            <img src={`../../../../images/file/${file.type}.png`} className="w-8 h-10 mt-1.5 ml-2.5"/>
                        )}
